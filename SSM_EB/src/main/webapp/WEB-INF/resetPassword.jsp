		...
		<div class="register_box">
			...
			<div class="security">
				<ul class="step">
					...
					<li><span class="line">2</span> <span>身份验证</span></li>
					<li><span class="line">3</span> <span>设置密码</span></li>
					<li><span class="line">4</span> <span>完成</span></li>
				</ul>
				<form action="resetPassword2">
					<ul class="list">
						<li><input id="J_euserName" class="long" name="name" value=""
							type="text" />
						...
						<li>
							<div class="name">图形验证码:</div> <input id="J_eUserNameCode"
							name="txtVcode" maxlength="4" style="margin-right: 6px;"
							type="text" /> <span class="code"> <img id="J_imgVcode"
								title="点击更换验证码" src="" alt="点击更换验证码" height="38" width="85" />
						</span> <a id="J_vcodeImgBtn" class="more" href="#">换一张</a>
						...
						<li>
							...
							value="下一步" /> <!-- <a id="J_eUserNameSubmit" class="btn_red"  href="resetPassword2" onclick="return false">下一步</a> -->
						</li>
					</ul>
				</form>
			</div>
