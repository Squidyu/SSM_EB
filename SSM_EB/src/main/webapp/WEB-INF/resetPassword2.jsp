			...
			<div class="security">
				...
				<form action="resetPassword3">
					<ul class="list">
						...
						<li><input id="J_euserName" class="long" name="phone" type="text" />
						...
						<li>
							...
							value="下一步" /> <!-- <a id="J_eUserNameSubmit"
							class="btn_red" href="resetPassword3" onclick="return false">下一步</a> -->
						</li>
					</ul>
				</form>
			</div>
